...
let flowerquotation = ["Love is the flower you’ve got to let grow", " Turn your face to the Sun, and shadows follow behind you","Experience is the teacher of all things"];
...
class sunflower {
  ...
  display(num,scaling) {
    push();
    translate(width / num, height / num);
